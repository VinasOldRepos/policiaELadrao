$('document').ready(function() {
    ...
    $.pegouMolotov = function() {
        ...
        if ($.alcancou(arrPosLadrao, TAMANHOOBJETO, arrPosMolotov, TAMANHODINHEIRO)) {
            ...
            $.ganhaPontos();
            $("#molotov").hide();
            $("#policiaImagem").attr("src", "/policiaELadrao/Application/View/img/guarda_fogo_02.gif");
            if (faseAtual >= FASEDOISPOLICIAS) {
                $("#policiaImagem2").attr("src", "/policiaELadrao/Application/View/img/guarda_fogo_02.gif");
            }
            molotovVis = false;
            $.feedBackMolotov();
        }
    ...
    $.mudaBackground = function() {
        $("#l_fundo").css(
            "background-image",
            "url(/policiaELadrao/Application/View/img/"+$.sorteiaFundo()+")"
        );
    }
